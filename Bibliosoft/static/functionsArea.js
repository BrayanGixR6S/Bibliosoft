...
$(function() {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            const table = new DataTable('#dataArea', {
                "data":response['datos'],
                "columns": [
                    {"data":response[0]},
                    {"data":response[1]},
            ...
            //*SELECT
            $('#dataArea tbody').on('click','tr', function() {
                var rowIndex = table.row(this).index();
                var idRow = $('#dataArea').DataTable().cell(rowIndex,0).data();
