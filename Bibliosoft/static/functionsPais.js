...
$(function() {
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            const table = new DataTable('#dataPais', {
                "data":response['datos'],
                "columns": [
                    {"data":response[0]},
                    {"data":response[1]},
            ...
            //*SELECT
            $('#dataPais tbody').on('click','tr', function() {
                var rowIndex = table.row(this).index();
                var idRow = $('#dataPais').DataTable().cell(rowIndex,0).data();
